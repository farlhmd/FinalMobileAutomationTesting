...
Mobile.waitForElementPresent(findTestObject('Side Menu/sideBtn - Logout'), 0)

Mobile.verifyElementVisible(findTestObject('Side Menu/sideBtn - Logout'), 0)

Mobile.tap(findTestObject('Side Menu/sideBtn - Logout'), 0)
